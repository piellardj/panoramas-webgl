...
var Page;!function(e){!function(e){function r(e){var r="div.tabs[id="+e+"-id]",n=document.querySelector(r);return n||console.error("Cannot find tabs '"+r+"'."),n}function n(e){for(var r=[],n=e.querySelectorAll("input"),t=0;t<n.length;t++){var a=n[t];a.checked&&r.push(a.value)}return r}e.addObserver=function(e,t){var a=r(e);if(a){var o=a.querySelectorAll("input");return Array.prototype.forEach.call(o,function(e){e.addEventListener("change",function(e){e.stopPropagation(),t(n(a))},!1)}),!0}return!1},e.getValues=function(e){var t=r(e);return t?n(t):[]},e.setValues=function(e,n){for(var t=r(e),a=t.querySelectorAll("input"),o=0;o<a.length;o++)a[o].checked=!1;for(var u=0,c=n;u<c.length;u++){var i=e+"-"+c[u]+"-id";t.querySelector("input[id="+i+"]").checked=!0}}}(e.Tabs||(e.Tabs={}))}(Page||(Page={}));
var Page;!function(n){!function(n){var e=16;function t(n){var e=document.querySelector(n);return e||console.error("Cannot find input file '"+n+"'."),e}function r(n){return t("input[type=file][id="+n+"]")}window.addEventListener("load",function(){var n=document.querySelectorAll(".file-control.upload > label");Array.prototype.forEach.call(n,function(n){var t=r(n.htmlFor);if(t){var o=n.querySelector("span");t.addEventListener("change",function(){var n;1===t.files.length&&(o.innerText=(n=t.files[0].name).length>e?n.substring(0,15)+"..."+n.substring(n.length-15):n)},!1)}})}),n.addDownloadObserver=function(n,e){var r=function(n){return t(".file-control.download > label[id="+n+"]")}(n);return!!r&&(r.addEventListener("click",function(){event.stopPropagation(),e()},!1),!0)},n.addUploadObserver=function(n,e){var t=r(n);return!!t&&(t.addEventListener("change",function(){event.stopPropagation(),1===t.files.length&&e(t.files)},!1),!0)}}(n.FileControl||(n.FileControl={}))}(Page||(Page={}));
var Page;!function(e){!function(e){function n(e){var n="input[type=checkbox][id="+e+"]",c=document.querySelector(n);return c||console.error("Cannot find checkbox '"+n+"'."),c}e.addObserver=function(e,c){var o=n(e);return!!o&&(o.addEventListener("change",function(e){e.stopPropagation(),c(o.checked)},!1),!0)},e.setChecked=function(e,c){var o=n(e);o&&(o.checked=!!c)},e.isChecked=function(e){var c=n(e);return!!c&&c.checked}}(e.Checkbox||(e.Checkbox={}))}(Page||(Page={}));
var Page;!function(e){!function(e){function n(e){var n="input[type=range][id="+e+"]",t=document.querySelector(n);return t||console.error("Cannot find range '"+n+"'."),t}var t=16;function o(e,n){n.textContent=e.value;var o=document.body.getBoundingClientRect(),r=e.getBoundingClientRect(),a=n.getBoundingClientRect(),u=(+e.value-+e.min)/(+e.max-+e.min),i=r.top-a.height-o.top-4,d=u*(r.width-t)+(r.left+.5*t)-o.left;n.style.top=i+"px",n.style.left=d-.5*a.width+"px"}function r(e,t,o){var r=n(e);return!!r&&(r.addEventListener(o,function(e){e.stopPropagation(),t(+r.value)},!1),!0)}window.addEventListener("load",function(){var e=document.querySelectorAll(".tooltip");Array.prototype.forEach.call(e,function(e){var n,t=e.previousElementSibling;(n=t).type&&"range"===n.type.toLowerCase()&&(t.parentNode.addEventListener("mouseenter",function(){o(t,e)},!1),t.addEventListener("input",function(){o(t,e)},!1))})});var a=!!window.MSInputMethodContext&&!!document.documentMode;e.addObserver=function(e,n){return r(e,n,a?"change":"input")},e.addLazyObserver=function(e,n){return r(e,n,"change")},e.getValue=function(e){var t=n(e);return t?+t.value:null},e.setValue=function(e,t){var o=n(e);o&&(o.value=""+t)}}(e.Range||(e.Range={}))}(Page||(Page={}));
